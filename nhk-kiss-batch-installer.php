<?php
/**
 * Plugin Name: KISS Smart Batch Installer MKIII
...
$update_checker = PucFactory::buildUpdateChecker(
    'https://github.com/kissplugins/KISS-Smart-Batch-Installer-MKIII',
    __FILE__,
...
function sbi_activate() {
    // Ensure container is initialized (activation runs before plugins_loaded)
    if ( ! sbi_container() ) {
        sbi_init();
    }
